...
This folder holds the **best things the whole project produced** — not a trading playbook, but the honest measurement rig and the infrastructure that ran it.

Study path: [`docs/experiment-guide.md`](../../docs/experiment-guide.md) · [`docs/watchdog-safety.md`](../../docs/watchdog-safety.md) · journey chapters [03](../../docs/journey/03-long-tail-sniper.md), [04](../../docs/journey/04-maker-btc.md), [05](../../docs/journey/05-oracle-gap.md).
